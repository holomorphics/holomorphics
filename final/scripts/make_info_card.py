...
# ===========================================================================
HOST = "holomorphics"   # shown as  holomorphics@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Self-directed builder & polymath"),
    ("kv", "Focus", "Roblox / Lua game scripting"),
    ("kv", "Also", "Web dev + creative tooling"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Scripting", "Lua, Luau"),
    ("kv", "Web", "JavaScript, TypeScript"),
    ("kv", "Systems", "C++, Python"),
    ("kv", "Creative", "Blender, motion graphics"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Building Roblox experiences with custom Lua server-side scripting"),
    ("bul", "Running a self-directed CS + creative curriculum in Obsidian"),
]
